 ...
 * @Description 完善商户信息Form
 * @Author jpg
 * @Date 2019年2月22日 下午3:12:16
 */
public class MerchantCompleteForm extends BaseForm {

	private static final long serialVersionUID = 5169357764463958566L;
	// 企业性质 0：企业 1：个人
	@NotBlank(message="商家性质不能为空")
	@Pattern(regexp = "[01]", message = "商家性质值只能为0或1")
	private String isEnterprise;
	// 名称
	@NotBlank(message="商家名称不能为空")
	@Size(min=1, max=50, message="商家名称1到50位之间")
    private String name;     
    // 法定代表人
